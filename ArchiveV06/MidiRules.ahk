...
/*
      The rules section is for modifying midi input from some other source.
        *See hotkeys below if you wish to generate midi messages from hotkeys.

      Write your own rules and put them in this section.
...
rules: ; write your own rules in here, look for : ++++++ for where you might want to add
           ; stay away from !!!!!!!!!!
